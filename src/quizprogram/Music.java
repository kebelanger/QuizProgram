...
public class Music extends Subject {
    ...
    public Music() {
        ...
        // add disney Quiz
        Quiz myDisneyQuiz = new Quiz(QuestionType.MUSIC);
        ...
        myDisneyQuiz.addQuestion(new Question(12, "Part_Of_Your_World.mp3", "The Little Mermaid", QuestionType.MUSIC));
        ...
        myDisneyQuiz.addQuestion(new Question(15, "Under_the_Sea.mp3", "The Little Mermaid", QuestionType.MUSIC));
